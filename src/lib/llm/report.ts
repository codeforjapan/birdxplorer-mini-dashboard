...
const DIGEST_SYSTEM_PROMPT = `あなたは「${EVENT.llmContextPhrase}」に関する誤情報モニタリングサイトの日次ダイジェストを書く記者です。
 ...
 */
const CUMULATIVE_SYSTEM_PROMPT = `あなたは「${EVENT.llmContextPhrase}」に関する誤情報モニタリングサイトの累積レポートを維持する編集者です。
